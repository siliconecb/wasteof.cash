<script>
  ...
  import { gettime, unescape, realcontentstuff, timetooltip, tmapcolor, hexToRgba} from "$lib/utils/postUtils.js";
  ...
  let finalcontent = realcontentstuff(unescaped);
...
<div
  class="box shadow-[0_0_0_1.5px_rgba(29,29,29,1)] rounded-[21px] min-h-[130px] w-[520px] bg-[#27292C] relative p-4 transition-[box-shadow] duration-300 ease-in-out hover:shadow-[0_0_0_0.55px_var(--hover-border-color)]"
